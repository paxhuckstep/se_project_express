...
const validateItemId = celebrate({
  params: Joi.object().keys({
    postId: Joi.string().alphanum().length(24).messages({
      ...
      "string.alphanum": "the id must be just letters and numbers, no special characters",
...
module.exports = { validateCardBody, validateItemId, validateLoginAttempt, validateNewUserData, validateUpdateUserData };
